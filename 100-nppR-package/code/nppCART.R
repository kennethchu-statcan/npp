...
#' @param predictors (optional) character vector of length at least 1. Column name(s) common to both 'np.data' and 'p.data' corresponding to predictor variables. If not specified, all column of 'p.data' except 'sampling.weight' and 'bootstrap.weights' are taken as predictors.
...
#' @param min.cell.size.np (optional) numeric vector of length 1 specifying the minimum number of non-probability samnple units in a node for partitioning to continue for that node. Must be a positive integer. If not specified, default value of 10 is used.
#' @param min.cell.size.p (optional) numeric vector of length 1 specifying the minimum number of probability samnple units in a node for partitioning to continue for that node. Must be a positive integer. If not specified, default value of 10 is used.
