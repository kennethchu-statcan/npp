...
Note that the data frame (here, assigned to __DF.npdata.estimated.propensity__)
returned by __nppCART$get_npdata_with_propensity( )__ is in fact the original
input data frame __DF.non.probability__
...
estimated propensities are under the __propensity__ column.
